...
val nameAndCountRegex = """\s*(\d+) (\w+ \w+) bag(?:s)?""".toRegex()
...
val String.countAndName
    get() = when {
        noOtherRegex.matches(this) -> null
            ...
            .let { (_, count, name) -> name to count.toUInt() }
    }

val dumbInput = """shiny gold bags contain 2 dark red bags.
dark red bags contain 2 dark orange bags.
dark orange bags contain 2 dark yellow bags.
dark yellow bags contain 2 dark green bags.
dark green bags contain 2 dark blue bags.
dark blue bags contain 2 dark violet bags.
dark violet bags contain no other bags.""".trimEnd('.')

val smallInput = """light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.""".trimEnd('.')
val rawInput = """vibrant lavender bags contain 1 shiny coral bag, 4 dotted purple bags.
...
dull lime bags contain 1 dark teal bag.""".trimEnd('.')
